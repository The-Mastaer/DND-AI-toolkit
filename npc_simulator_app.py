...
class NpcSimulatorApp(customtkinter.CTkToplevel):
    ...
    def _clear_window(self):
        """Destroys all widgets inside the main window."""
    ...
    def _on_npc_selected(self, npc_name):
        """Handles the selection of an NPC and transitions to the simulator view."""
        npcs = self.db.load_data()
    ...
    def _create_simulator_view(self):
        """Creates the main simulator UI with a sidebar and content area."""
        self._clear_window()
    ...
    def _setup_sidebar(self):
        """Creates the left sidebar with NPC info and portrait."""
        ...
        tags = [
            self.npc_data.get('gender'), self.npc_data.get('attitude'), self.npc_data.get('rarity')
        ]
    ...
    def _setup_main_content(self):
        """Creates the main content area for simulation."""
        ...
        self.simulate_button = customtkinter.CTkButton(main_frame, text="Simulate Reaction", height=40,
    ...
    def _run_simulation_task(self):
        """The actual task of calling the AI to simulate a reaction."""
        ...
        try:
            ...
            response_text = self.ai.simulate_reaction(self.npc_data, situation)
